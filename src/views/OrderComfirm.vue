                ...
                <div id="mainPanel" style="width: 100%;">
                    <el-container style="width: 84%; margin-left: 8%;">
                        ...
                        <div style="margin-top: 20px;margin-bottom: -60px;">
                            ...
                            <img v-if="!isUnion" src="../assets/UnionPay.jpg" border="2" @click="unionpay"
                            style="cursor: pointer;border-radius: 10px; border-color: rgb(201, 202, 211);"/>
                            <img v-if="isUnion" src="../assets/UnionPay.jpg" border="2" @click="unionpayCancel"
...
export default {
        ...
        buy(){
            ...
            /*axios.post('/api/order/place_order', {
                ...
                this.$alert('购买成功！', '恭喜', {
                    confirmButtonText: '确定',
                    callback: action => {
                        this.$router.push({ path: "/OrderDetail", query: {id: response.data.order_id} });
                        console.log("!!!");
                    }
                 });
            })*/
            ...
            this.$alert('购买成功！', '恭喜', {
                confirmButtonText: '确定',
                callback: action => {
                    this.$router.push({ path: "/OrderDetail", query: {id: dinfo.order_id} });
                    console.log("!!!");
                }
            });*/
        }
    ...
    computed:{
        ...
        let detailArr = this.$route.query.ids;
        let t = this;
